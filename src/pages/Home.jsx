                    ...
                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={`peer input-field ios-date-input min-h-12 w-full cursor-pointer border-gray-200 focus:ring-primary-900 sm:min-h-14 ${formData.pickupDate ? 'text-black' : 'text-transparent'
                            }`}
                          required
                        />
                      ...
                      <div className="relative">
                        <input
                          ...
                          onClick={(e) => e.currentTarget.showPicker?.()}
                          step="300"
                          className={`peer input-field ios-date-input min-h-12 w-full cursor-pointer border-gray-200 focus:ring-primary-900 sm:min-h-14 ${formData.pickupTime ? 'text-black' : 'text-transparent'
                            }`}
                          required
                        />
